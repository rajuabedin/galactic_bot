    ...
    async execute(interaction, userInfo, serverSettings) {
        ...
        try {
            ...
            if (dailyInfo.length == 0) {
                ...
                //return await interaction.editReply({ embeds: [interaction.client.greenEmbed("You have successfully claimed your daily reward.", "Successfull")], components: [] })
                diffInDays = 1;
                dailyInfo = {
                    streak: 1
                }
            ...
            if (2 > diffInDays && diffInDays >= 1) {
                ...
                return await interaction.editReply({ embeds: [interaction.client.greenEmbed(interaction.client.getWordLanguage(serverSettings.lang, "daily_reward_msg").format(reward, (dailyInfo.streak - 1)), interaction.client.getWordLanguage(serverSettings.lang, 'daily_reward'))], components: [] })
                ...
                return await interaction.editReply({ embeds: [interaction.client.greenEmbed(interaction.client.getWordLanguage(serverSettings.lang, "daily_reward_msg").format(reward, 0), interaction.client.getWordLanguage(serverSettings.lang, 'daily_reward'))], components: [] })
            } else {
                return await interaction.editReply({ embeds: [interaction.client.redEmbed(interaction.client.getWordLanguage(serverSettings.lang, "daily_claimed_error"), interaction.client.getWordLanguage(serverSettings.lang, "claimed"))], components: [] })
            }
