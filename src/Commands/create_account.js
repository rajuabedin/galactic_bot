        ...
        try {
            ...
            if (typeof userInfo === 'undefined') {
                ...
                if (tutorialCounter == 1) {
                    ...
                    await interaction.reply({ embeds: [interaction.client.greenEmbed(interaction.client.getWordLanguage(serverSettings.lang, 'TC1_1'), interaction.client.getWordLanguage(serverSettings.lang, 'tutorilPhase').format('2'))], components: [tutorial] });
                }
                else if (tutorialCounter == 2) {
                    await interaction.reply({ embeds: [interaction.client.greenEmbed(interaction.client.getWordLanguage(serverSettings.lang, 'TC2_1'), interaction.client.getWordLanguage(serverSettings.lang, 'tutorilPhase').format('3'))], components: [tutorial] });
                }
                else if (tutorialCounter == 3) {
                    await interaction.reply({ embeds: [interaction.client.greenEmbed(interaction.client.getWordLanguage(serverSettings.lang, 'TC3_1'), interaction.client.getWordLanguage(serverSettings.lang, 'tutorilPhase').format('4'))], components: [tutorial] });
                    ...
                    await interaction.reply({ content: " ", embeds: [interaction.client.greenEmbed(interaction.client.getWordLanguage(serverSettings.lang, 'TC4_1'), interaction.client.getWordLanguage(serverSettings.lang, 'tutorilPhase').format('5'))], components: [tutorial] });
                }
                    ...
                    if (typeof mission == 'undefined' || mission.length == 0) {
                        await interaction.reply({ embeds: [interaction.client.greenEmbed(interaction.client.getWordLanguage(serverSettings.lang, 'TC5_1'), interaction.client.getWordLanguage(serverSettings.lang, 'tutorilPhase').format('6'))], components: [tutorial] });
                    }
                    else if (mission[0].mission_status === 'active') {
                        await interaction.reply({ embeds: [interaction.client.redEmbed("To continue, you need to complete the mission\nTo complete the mission do **/hunt**\nYou can check the status of the mission by doing **/mission**", interaction.client.getWordLanguage(serverSettings.lang, 'tutorilPhase').format('6'))] })
                        return;
                    }
                    else {
                        tutorialCounter++;
                        phaseCounter = 1;
                        await interaction.reply({ embeds: [interaction.client.greenEmbed(`Congratulations on finishing your first mission!\nYou are rewarded with one **L4E- laser cannon**`, interaction.client.getWordLanguage(serverSettings.lang, 'tutorilPhase').format('6'))], components: [tutorial] });
                    ...
                    await i.update({ content: " ", embeds: [interaction.client.greenEmbed(interaction.client.getWordLanguage(serverSettings.lang, 'TC6_1'), interaction.client.getWordLanguage(serverSettings.lang, 'tutorilPhase').format('7'))], components: [tutorial] });
                }
            }
            ...
            collector.on('collect', async i => {
                ...
                if (tutorialCounter == 0) {
                    ...
                    await i.update({ embeds: [interaction.client.greenEmbed(interaction.client.getWordLanguage(serverSettings.lang, 'TC0').format(i.customId), interaction.client.getWordLanguage(serverSettings.lang, 'tutorilPhase').format('1'))], components: [tutorial] });
                    ...
                    if (phaseCounter == 1) {
                        await i.update({ embeds: [interaction.client.greenEmbed(interaction.client.getWordLanguage(serverSettings.lang, 'TC1_1'), interaction.client.getWordLanguage(serverSettings.lang, 'tutorilPhase').format('2'))], components: [tutorial] });
                        phaseCounter++;
                    }
                    if (phaseCounter == 2) {
                        tutorialCounter++;
                        if (selectedFirm === "Terra") {
                            await i.update({ embeds: [interaction.client.blueEmbed(interaction.client.getWordLanguage(serverSettings.lang, 'TC1_2').format('1-1'), interaction.client.getWordLanguage(serverSettings.lang, 'tutorilPhase').format('2'))], components: [] });
                            ...
                            await i.update({ embeds: [interaction.client.greenEmbed(interaction.client.getWordLanguage(serverSettings.lang, 'TC1_2T'), interaction.client.getWordLanguage(serverSettings.lang, 'tutorilPhase').format('2'))], components: [tutorial] });
                            ...
                            await i.update({ embeds: [interaction.client.blueEmbed(interaction.client.getWordLanguage(serverSettings.lang, 'TC1_2').format('2-1'), interaction.client.getWordLanguage(serverSettings.lang, 'tutorilPhase').format('2'))], components: [] });
                            ...
                            await interaction.client.wait(1000);
                            await interaction.editReply({ embeds: [interaction.client.greenEmbed(interaction.client.getWordLanguage(serverSettings.lang, 'TC1_2L'), interaction.client.getWordLanguage(serverSettings.lang, 'tutorilPhase').format('2'))], components: [tutorial] });
                            await interaction.client.databaseEditData(`INSERT INTO user_lasers (user_id, laser_model) VALUES (?, ?)`, [interaction.user.id, "L3"]);
                        }
                        else {
                            await i.update({ embeds: [interaction.client.blueEmbed(interaction.client.getWordLanguage(serverSettings.lang, 'TC1_2').format('3-1'), interaction.client.getWordLanguage(serverSettings.lang, 'tutorilPhase').format('2'))], components: [] });
                            ...
                            await interaction.client.wait(1000);
                            await interaction.editReply({ embeds: [interaction.client.greenEmbed(interaction.client.getWordLanguage(serverSettings.lang, 'TC1_2M'), interaction.client.getWordLanguage(serverSettings.lang, 'tutorilPhase').format('2'))], components: [tutorial] });
                            await interaction.client.databaseEditData(`INSERT INTO user_lasers (user_id, laser_model) VALUES (?, ?)`, [interaction.user.id, "L3"]);
                        }
                        phaseCounter = 1;
                    }
                    ...
                    if (phaseCounter == 1) {
                        await i.update({ embeds: [interaction.client.greenEmbed(interaction.client.getWordLanguage(serverSettings.lang, 'TC2_1'), interaction.client.getWordLanguage(serverSettings.lang, 'tutorilPhase').format('3'))], components: [tutorial] });
                        phaseCounter++;
                    }
                        ...
                        if (laserEquipped) {
                            if (i.customId === "0") {
                                ...
                                tutorialCounter++;
                                phaseCounter = 1;
                                await i.update({ embeds: [interaction.client.greenEmbed(interaction.client.getWordLanguage(serverSettings.lang, 'TC2_2'), interaction.client.getWordLanguage(serverSettings.lang, 'tutorilPhase').format('3'))], components: [tutorial] });
                    ...
                    if (phaseCounter == 1) {
                        await i.update({ content: " ", embeds: [interaction.client.greenEmbed(interaction.client.getWordLanguage(serverSettings.lang, 'TC3_1'), interaction.client.getWordLanguage(serverSettings.lang, 'tutorilPhase').format('4'))], components: [tutorial] });
                        phaseCounter++;
                        row = await buttonHandlerOnOff(0);
                    }
                    else if (phaseCounter == 2) {
                        await i.update({ embeds: [interaction.client.blueEmbed(interaction.client.getWordLanguage(serverSettings.lang, 'TC3_2'), interaction.client.getWordLanguage(serverSettings.lang, 'tutorilPhase').format('4'))], components: [row] });
                        phaseCounter++;
                    }
                    else if (phaseCounter == 3) {
                        if (i.customId === "activateButton") {
                            row = await buttonHandlerOnOff(1);
                            await i.update({ embeds: [interaction.client.blueEmbed(interaction.client.getWordLanguage(serverSettings.lang, 'TC3_3'), interaction.client.getWordLanguage(serverSettings.lang, 'tutorilPhase').format('4'))], components: [row] });
                            phaseCounter++;
                        }
                        else {
                            await i.update({ embeds: [interaction.client.redEmbed(interaction.client.getWordLanguage(serverSettings.lang, 'TC3_3_2'), interaction.client.getWordLanguage(serverSettings.lang, 'tutorilPhase').format('4'))], components: [row] });
                        }
                    }
                    else if (phaseCounter == 4) {
                        if (i.customId === "save2") {
                            await i.update({ embeds: [interaction.client.greenEmbed(interaction.client.getWordLanguage(serverSettings.lang, 'TC3_4'), interaction.client.getWordLanguage(serverSettings.lang, 'tutorilPhase').format('4'))], components: [tutorial] });
                            phaseCounter++;
                        }
                        else {
                            await i.update({ embeds: [interaction.client.redEmbed(interaction.client.getWordLanguage(serverSettings.lang, 'TC3_4_2'), interaction.client.getWordLanguage(serverSettings.lang, 'tutorilPhase').format('4'))], components: [row] });
                        }
                    }
                    else if (phaseCounter == 5) {
                        [hp, sh] = await configurationHandler(-1, "DANGER");
                        await i.update({ embeds: [interaction.client.blueEmbed(interaction.client.getWordLanguage(serverSettings.lang, 'TC3_5'), interaction.client.getWordLanguage(serverSettings.lang, 'tutorilPhase').format('4'))], components: [hp, sh, settingRow] });
                        phaseCounter++;
                    }
                    else if (phaseCounter == 6) {
                        if (i.customId === "empty") {
                            [hp, sh] = await configurationHandler();
                            await i.update({ embeds: [interaction.client.blueEmbed(interaction.client.getWordLanguage(serverSettings.lang, 'TC3_6'), interaction.client.getWordLanguage(serverSettings.lang, 'tutorilPhase').format('4'))], components: [hp, sh, settingRow] });
                            phaseCounter++;
                        }
                        else {
                            ...
                            if (i.customId === "disable" || index == 9) {
                                [hp, sh] = await configurationHandler(-1, "DANGER");
                                await i.update({ embeds: [interaction.client.redEmbed(interaction.client.getWordLanguage(serverSettings.lang, 'TC3_6_2'), interaction.client.getWordLanguage(serverSettings.lang, 'tutorilPhase').format('4'))], components: [hp, sh, settingRow] });
                            }
                            else if (index < 5) {
                                [hp, sh] = await configurationHandler(index);
                                await i.update({ embeds: [interaction.client.redEmbed(interaction.client.getWordLanguage(serverSettings.lang, 'TC3_6_2').format((index + 1) * 20), interaction.client.getWordLanguage(serverSettings.lang, 'tutorilPhase').format('4'))], components: [hp, sh, settingRow] });
                            }
                            else if (index < 9) {
                                [hp, sh] = await configurationHandler(index);
                                await i.update({ embeds: [interaction.client.redEmbed(interaction.client.getWordLanguage(serverSettings.lang, 'TC3_6_2').format((index + 1) * 20 - 100), interaction.client.getWordLanguage(serverSettings.lang, 'tutorilPhase').format('4'))], components: [hp, sh, settingRow] });
                            }
                        }
                    }
                    else if (phaseCounter == 7) {
                        if (i.customId === "save") {
                            await i.update({ embeds: [interaction.client.greenEmbed(interaction.client.getWordLanguage(serverSettings.lang, 'TC3_7'), interaction.client.getWordLanguage(serverSettings.lang, 'tutorilPhase').format('4'))], components: [tutorial] });
                            phaseCounter = 1;
                            tutorialCounter++;
                            await interaction.client.databaseEditData(`UPDATE users SET tutorial_counter = ? WHERE user_id = ?`, [tutorialCounter, interaction.user.id]);
                            ...
                            await i.update({ embeds: [interaction.client.redEmbed(interaction.client.getWordLanguage(serverSettings.lang, 'TC3_7_2'), interaction.client.getWordLanguage(serverSettings.lang, 'tutorilPhase').format('4'))], components: [hp, sh, settingRow] });
                        }
                    }
                }
                else if (tutorialCounter == 4) {
                    if (phaseCounter == 1) {
                        ...
                        await i.update({ content: " ", embeds: [interaction.client.greenEmbed(interaction.client.getWordLanguage(serverSettings.lang, 'TC4_1'), interaction.client.getWordLanguage(serverSettings.lang, 'tutorilPhase').format('5'))], components: [tutorial] });
                        phaseCounter++;
                    }
                    else if (phaseCounter == 2) {
                        await i.update({ embeds: [interaction.client.blueEmbed(items[0][0], interaction.client.getWordLanguage(serverSettings.lang, 'tutorilPhase').format('5'))], components: [shopRow] });
                        phaseCounter++;
                        index = 0;
                        ...
                        if (i.customId == "right") {
                            ...
                            if (index > maxIndex)
                                index = 0;
                            await i.update({ embeds: [interaction.client.blueEmbed(items[index][0], interaction.client.getWordLanguage(serverSettings.lang, 'tutorilPhase').format('5'))] });
                        }
                            ...
                            if (items[index][1] === 2) {
                                quantity = 1;
                                await i.update({ embeds: [interaction.client.blueEmbed(interaction.client.getWordLanguage(serverSettings.lang, 'TC4_3').format(interaction.client.defaultEmojis['credit'], userInfo.credit, interaction.client.defaultEmojis['credit'], items[index][2]), interaction.client.getWordLanguage(serverSettings.lang, 'tutorilPhase').format('5'))], components: [quantityButtonUp, quantityButtonDown, buySetting] });
                                phaseCounter++;
                            }
                            else {
                                await i.update({ embeds: [interaction.client.redEmbed(interaction.client.getWordLanguage(serverSettings.lang, 'TC4_3_2'), interaction.client.getWordLanguage(serverSettings.lang, 'tutorilPhase').format('5'))] });
                            }
                        }
                    }
                    else if (phaseCounter == 4) {
                        if (i.customId === "buyItem") {
                            if (quantity == 100) {
                                tutorialCounter++;
                                await i.update({ embeds: [interaction.client.greenEmbed(interaction.client.getWordLanguage(serverSettings.lang, 'TC4_4'), interaction.client.getWordLanguage(serverSettings.lang, 'tutorilPhase').format('5'))], components: [tutorial] });
                                ...
                                await i.update({ embeds: [interaction.client.redEmbed(interaction.client.getWordLanguage(serverSettings.lang, 'TC4_4_2').format(quantity), interaction.client.getWordLanguage(serverSettings.lang, 'tutorilPhase').format('5'))], components: [quantityButtonUp, quantityButtonDown] });
                            }
                        }
                        else {
                            ...
                            if (quantity < 1) {
                                quantity -= add;
                                await i.update({ embeds: [interaction.client.redEmbed(interaction.client.getWordLanguage(serverSettings.lang, 'TC4_4_3').format(quantity), interaction.client.getWordLanguage(serverSettings.lang, 'tutorilPhase').format('5'))], components: [quantityButtonUp, quantityButtonDown] });
                            }
                            else
                                await i.update({ embeds: [interaction.client.blueEmbed(interaction.client.getWordLanguage(serverSettings.lang, 'TC4_4_4').format(interaction.client.defaultEmojis['credit'], userInfo.credit, interaction.client.defaultEmojis['units'], userInfo.units, quantity, interaction.client.defaultEmojis['credit'], items[index][2] * quantity), interaction.client.getWordLanguage(serverSettings.lang, 'tutorilPhase').format('5'))], components: [quantityButtonUp, quantityButtonDown, buySetting] });
                        }
                    }
                }
                else if (tutorialCounter == 5) {
                    if (phaseCounter == 1) {
                        await i.update({ content: " ", embeds: [interaction.client.greenEmbed(interaction.client.getWordLanguage(serverSettings.lang, 'TC5_1'), interaction.client.getWordLanguage(serverSettings.lang, 'tutorilPhase').format('6'))], components: [tutorial] });
                        phaseCounter++;
                    }
                    else if (phaseCounter == 2) {
                        message = interaction.client.getWordLanguage(serverSettings.lang, 'TC5_2');
                        if (i.customId === "get") {
                            await i.update({ embeds: [interaction.client.blueEmbed(interaction.client.getWordLanguage(serverSettings.lang, 'TC5_2_2'), interaction.client.getWordLanguage(serverSettings.lang, 'tutorilPhase').format('6'))], components: [rowYesNo] });
                            phaseCounter++;
                        }
                        else
                        ...
                        if (i.customId === "yes") {
                            await i.update({ embeds: [interaction.client.greenEmbed(interaction.client.getWordLanguage(serverSettings.lang, 'TC5_3'), interaction.client.getWordLanguage(serverSettings.lang, 'tutorilPhase').format('6'))], components: [] })
                            ...
                            await i.update({ embeds: [interaction.client.redEmbed(interaction.client.getWordLanguage(serverSettings.lang, 'TC5_3_2'), interaction.client.getWordLanguage(serverSettings.lang, 'tutorilPhase').format('6'))], components: [rowYesNo] });
                        }
                    }
                }
                else if (tutorialCounter == 6) {
                    ...
                    if (phaseCounter == 2) {
                        ...
                        message += `${cargo}` + " \`\`\`";
                        await i.update({ content: " ", embeds: [interaction.client.greenEmbed(message, interaction.client.getWordLanguage(serverSettings.lang, 'tutorilPhase').format('7'))] });
                    ...
                    if (phaseCounter == 3) {
                        await i.update({ content: " ", embeds: [interaction.client.greenEmbed(interaction.client.getWordLanguage(serverSettings.lang, 'TC6_3'), interaction.client.getWordLanguage(serverSettings.lang, 'tutorilPhase').format('7'))], components: [tutorial] });
