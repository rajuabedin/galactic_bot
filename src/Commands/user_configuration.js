    ...
    .addComponents(
        new MessageSelectMenu()
            ...
            .addOptions([
                ...
                {
                    label: 'x2',
                    description: 'Use laser x2 util... ',
                    value: 'x2',
                },
                {
                    label: 'x3',
                    description: 'Use laser x3 util... ',
                    value: 'x3',
                },
                {
                    label: 'x4',
                    description: 'Use laser x4 util... ',
                    value: 'x4',
                },
                {
                    label: 'xS1',
                    description: 'Use laser xS1 util... ',
                    value: 'xS1',
                },
                {
                    label: 'm2',
                    description: 'Use missile m2 util... ',
                    value: 'm2',
                },
                {
                    label: 'm3',
                    description: 'Use missile m3 util... ',
                    value: 'm3',
                },
                {
                    label: 'm4',
                    description: 'Use missile m4 util... ',
                    value: 'm4',
                },
                {
                    label: 'h2',
                    description: 'Use hellstorm h2 util... ',
                    value: 'h2',
                },
                {
                    label: 'hS1',
                    description: 'Use hellstorm hS1 util... ',
                    value: 'hS1',
                },
                {
                    label: 'hS2',
                    description: 'Use hellstorm hS2 util... ',
                    value: 'hS2',
                },
            ]),
    )
